...
Route::prefix('soporte')->group(function () {
    ...
    Route::get('/calificar-ticket/{ticket}', [TicketSoporteController::class, 'calificar_soporte_vista'])->name('soporte.calificar_ticket');
    Route::post('/calificar-ticket', [TicketSoporteController::class, 'registrar_calificacion_soporte'])->name('soporte.registrar_califcacion');
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::prefix('tecnico')->group(function(){
            ...
            Route::get('/ver-calificaciones', [TicketSoporteController::class, 'ver_calificaciones_tecnicos'])->name('soporte.ver.calificaciones.tecnicos');
        ...
        Route::prefix('revisor')->group(function(){
            Route::get('/listado-tickets', [TicketSoporteController::class, 'listado_tickets_revisor'])->name('soporte.listado.revisor');
            Route::get('/editar-ticket/{ticket}', [TicketSoporteController::class, 'editar_ticket_revisor'])->name('soporte.editar.revisor');
            Route::get('/estado-de-tecnicos', [TicketSoporteController::class, 'listado_estado_tecnicos'])->name('soporte.listado.estado_tecnicos');
            Route::post('/listado-tickets', [TicketSoporteController::class, 'filtrado_tickets_revisor'])->name('soporte.listado_filtrado.revisor');
            Route::delete('/eliminar-soporte/{ticket}', [TicketSoporteController::class, 'eliminar_soporte_revisor'])->name('soporte.eliminar_ticket');
        ...
        Route::prefix('soporte-especial')->group(function () {
            ...
            Route::post('/registrar-ventas/{factura}', [SoporteEspcialController::class, 'registrar_capacitacion_ventas'])->name('soporte.registrar_capacitacion_ventas');
            ...
            /* Revisor */
            Route::get('/listado', [SoporteEspcialController::class, 'revisor_listar_soporte_especial'])->name('soporte.revisor_listar_soporte_especial');
            Route::post('/filtrado', [SoporteEspcialController::class, 'filtrado_soporte_especial'])->name('soporte.filtrado_soporte_especial');
