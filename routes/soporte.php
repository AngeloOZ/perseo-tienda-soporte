...
Route::prefix('soporte')->group(function () {
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::get('redirect-index-by-rol', function () {
        ...
        /* Rol de desarrollo */
        Route::get('/listado-tickets-desarrollo-revisor', [TicketSoporteController::class, 'listado_de_tickets_desarrollo_revisor'])->name("soporte.listado.revidor.desarrollo");
        Route::get('/editar-ticket-desarrollo/{ticket}', [TicketSoporteController::class, 'editar_ticket_desarrollo'])->name('soporte.editar.desarrollo');
        ...
        Route::prefix('especiales')->group(function () {
