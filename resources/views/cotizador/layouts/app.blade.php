...
<body id="kt_body"
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
        @include('auth.include.navBarMobile')
    </div>
    ...
    <script src="{{ asset('assets/plugins/custom/sum().js') }}"></script>
    ...
    @yield('script')
    @yield('scriptTabs')
    @yield('scriptDropzone')
    @yield('scriptFecha')
    @yield('scriptMenu')
    @yield('script2')
    @yield('script3')
    @yield('script6')
    @yield('scriptDetalles')
