@if (Auth::guard('admin')->user()->administrador == 1 || Auth::guard('admin')->user()->vendedor == 1)
    @php
        $prospectos = App\Models\Prospectos::select('prospectosid', 'razonsocial')
            ->where('distribuidoresid', Auth::guard('admin')->user()->distribuidoresid)
            ->where('subdistribuidoresid', Auth::guard('admin')->user()->subdistribuidoresid)
            ->where('activo', 1)
            ->get();
        ...
        if(!isset($cotizaciones->prospectosid)){
            $cliente = 1;
        }else{
            $cliente = 0;
        }
                                    ...
                                    <div class="card-body">
                                                    ...
                                                    <select class="form-control select2" id="prospectosid" name="prospectosid">
                                                        ...
                                                        @foreach ($prospectos as $prospectosD)
                                                            <option value="{{ $prospectosD->prospectosid }}"
                                                                {{ $prospectosD->prospectosid == $cotizaciones->prospectosid ? 'selected' : '' }}>
                                                    ...
                                                    <select class="form-control select2" id="clientesid" name="clientesid">
                                                        ...
                                                        @foreach ($clientes as $clientesD)
                                                            <option value="{{ $clientesD->clientesid }}"
                                                                {{ $clientesD->clientesid == $cotizaciones->clientesid ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control" placeholder=""
                                                    ...
                                                    value="{{ $cotizaciones->subtotal }}" readonly />
                                            </div>
                                            <div class="col-lg-6">
                                                <label>Iva:</label>
                                                <input type="text" class="form-control" placeholder=""
                                                    name="iva" autocomplete="off" id="iva"
                                                    value="{{ $cotizaciones->iva }}" readonly />
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control" placeholder=""
                                                    name="total" id="total"
                                                    value="{{ $cotizaciones->total }}" readonly />
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            @if ($cotizaciones->fechacreacion != null)
                                                <div class="col-lg-6">
                                                    ...
                                                    <input type="text" class="form-control" placeholder=""
                                                        name="fechamodificacion" autocomplete="off" id="fechamodificacion"
