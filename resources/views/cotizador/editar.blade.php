            ...
            <div class="d-flex flex-column-fluid">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <!--begin::Card-->
                            <form class="form" action="{{ route('detalles.actualizar', $detalles->detallesid) }}"
                                method="POST">
                                @method('PUT')
                                <div class="card card-custom card-sticky" id="kt_page_sticky_card">
                                    ...
                                    <div class="card-body">
                                        @include('backend.cotizar.plantilla1._form')
                                    </div>
                                </div>
                                <!--end::Card-->
                            </form>
