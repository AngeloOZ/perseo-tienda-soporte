                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 28px; line-height: 39.2px;"><strong><span
                                                                                style="line-height: 39.2px; font-size: 28px;">Notificación
                                                                                de la tienda.</span></strong>
                                                                    </span>
                                                                </p>
                                                            </div>
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 160%;">
                                                                    <span
                                                                        style="font-size: 22px; line-height: 45.2px; font-family: 'Open Sans', sans-serif; font-weight: 500;">
                                                                        ¡Hola! <strong>{{ $array['vendedor'] }}</strong>😊☀️<br />
                                                                        Notamos que el cliente <strong>{{ $array['cliente'] }}</strong>
                                                                        no está bajo tu responsabilidad. Por favor,
                                                                        amablemente redirígelo a su asesor
