                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                ¡Saludos, <strong>{{ $array['revisora'] }}</strong>! Te informamos que se ha registrado un nuevo cobro en nuestra plataforma para su revisión. A continuación, te proporcionamos los detalles:
                                                                <br><br>
                                                                Los números de facturas asociadas al cobro son los siguientes:
                                                                <ul>
                                                                    @foreach ($array['sencuencias'] as $item)
                                                                        <li>{{ $item }}</li>
                                                                    @endforeach
                                                                </ul>
                                                                <!--inicio cambio-->
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 180%;"><span
                                                                        style="font-size: 16px; line-height: 28.8px;">PerseoSoft {{ date('Y') }} © | Todos los derechos
                                                                        reservados.</span></p>
                                                                <p style="font-size: 14px; line-height: 180%;"><span
