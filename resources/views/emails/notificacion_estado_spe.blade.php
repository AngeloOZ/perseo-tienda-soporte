                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Arial',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                ¡Saludos, {{ $array['revisora'] }}! Queremos informarte que la capacitación número <strong>{{ $array['soporteid'] }}</strong> ha sido actualizada al estado <strong>{{ $array['estado'] }}</strong> en la fecha {{ $array['fecha'] }}. A continuación, te brindaremos más detalles sobre la implementación.
                                                                <br><br>
