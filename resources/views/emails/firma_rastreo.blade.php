                                ...
                                <div class="u-col u-col-100"
                                    ...
                                    <div style="height: 100%;width: 100% !important;">
                                        ...
                                        <div
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                Hola, <strong>{{ $array['nombres'] }}</strong> tu
                                                                solicitud de la firma
                                                                electrónica se
                                                                encuentra "<strong>En proceso</strong>" de ahora en
                                                                adelante
                                                                puedes seguir el estado de solicitud en el siguiente
                                                                enlace:
                                                                <br><br>
                                                                <a href="{{ route('firma.estadosolicitud', $array['id_firma']) }}"
                                                                    target="_blank" rel="noopener noreferrer">Clic
                                                                    para ver
                                                                    estado de la
                                                                    solicitud</a>

                                                                <br><br>
                                                                Sino funciona el hipervínculo copia y pega el sigueinte
                                                                enlace:
                                                                {{ route('firma.estadosolicitud', $array['id_firma']) }}
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            ...
                                            <table style="font-family:'Cabin',sans-serif; margin-bottom: 30px" role="presentation"
                                                cellpadding="0" cellspacing="0" width="100%" border="0">
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 55px;font-family:'Cabin',sans-serif;"
                                                            align="left">
                                                            <div
                                                                style="line-height: 130%; text-align: justify; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 160%; text">
                                                                    <strong style="font-size: 16px">NOTA:</strong> Para la generación de la contraseña de su certificado, usar números y letras, excepto la ñ, sin caracteres especiales. De igual manera, la firma debe ser descargada únicamente desde computadora. <strong>PerseoSoft</strong> no se responsabiliza si tiene problemas al autorizar documentos, por tema de claves no válidas o mal descargadas.
                                                                </p>
