        ...
        <tbody>
            <tr style="vertical-align: top">
                <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                    ...
                    <div class="u-row-container" style="padding: 0px;background-color: transparent">
                        <div class="u-row"
                            style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #2c2c2c;">
                            <div
                                style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
                                <div class="u-col u-col-100"
                                    style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 16px; line-height: 160%;">
                                                                    Hola, <strong>{{ $array['razon_social'] ?? '' }}</strong> tu soporte ha concluido, por favor ayúdanos calificando, como ha sido tu experiencia durante el proceso del soporte recibido en el siguiente enlace.
                                                                </p>
                                                                <br>
                                                                <div>
                                                                    Enlace de la encuesta: <a href="https://tienda.socio-perseo.com/soporte/calificar-soporte/{{ $array['ticketid'] }}" target="_blank" rel="noopener noreferrer">Calificar clic aquí</a>
                                                                    <br><br>
                                                                    Si no funciona el enlace, copia y pega este enlace en tu navegador: 
                                                                    <br>
                                                                    <span style="font-family: sans-serif">https://tienda.socio-perseo.com/soporte/calificar-soporte/{{ $array['ticketid'] }}</span>
                                                                    <br><br>
                                                                    <strong>NOTA:</strong> Recuerda que para solicitar otro soporte debes calificar este soporte primero, ya que esto nos ayuda a mejorar, te agradecemos tu compresión.
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                    ...
                    <div class="u-row-container" style="padding: 0px;background-color: transparent">
                        <div class="u-row"
                            style="margin: 0 auto; min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #2c2c2c; font-family:'Cabin',sans-serif;">
                            <div style="color: #fff; padding: 10px; text-align: center">
                                <a href="https://www.facebook.com/sistemacontableperseoec" target="_blank"
                                    class="redes_icon facebook" style="background: #3B5998;">
                                    <img height="30"
                                        src="{{ $message->embed(public_path() . '/assets/media/facebook.png') }}"
                                        style="border-radius:50%;display:block;" width="30">
                                </a>
                                <a href="https://www.instagram.com/sistemacontableperseoec/?hl=es" target="_blank"
                                    class="redes_icon instagram" style="background: #DD2A7B; margin: 0 5px;">
                                    <img height="30"
                                ...
                                <a href="https://www.youtube.com/channel/UC5vW4mwvCNbWpCxRr_aqI7g" target="_blank"
                                    class="redes_icon youtube" style="background: #C4302B;">
                                    <img height="30"
                    ...
                    <div class="u-row-container" style="padding: 0px;background-color: transparent">
                        <div class="u-row"
                            ...
                            <div style="padding: 10px; text-align: center; height: 60px">
                                <p
                                    style="font-size: 14px; line-height: 60px; color: #fff; font-family:'Cabin',sans-serif;">
                                    <span style="font-size: 16px;">Perseo {{ date('Y') }} © | Todos los
