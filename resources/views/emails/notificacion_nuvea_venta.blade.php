                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                ¡Saludos, <strong>{{ $array['revisora']}}</strong>! Te informamos que se ha registrado una nueva venta en la tiendita. A continuación, te proporcionamos los detalles de la venta:
                                                                <br><br>
