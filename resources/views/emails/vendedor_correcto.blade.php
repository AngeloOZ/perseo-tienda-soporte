                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 28px; line-height: 39.2px;"><strong><span
                                                                                style="line-height: 39.2px; font-size: 28px;">Notificaciones
                                                                                licenciador.</span></strong>
                                                                    </span>
                                                                </p>
                                                            </div>
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 160%;">
                                                                    <span
                                                                        style="font-size: 20px; line-height: 35.2px; font-family: 'Open Sans', sans-serif;">
                                                                        ¡Atención,
                                                                        <strong>{{ $array['vendedor1'] }}</strong>!
                                                                        Hemos
                                                                        notado que el vendedor
                                                                        <strong>{{ $array['vendedor2'] }}</strong>
                                                                        intentó crear una ficha de: (LITE, DEMO o
                                                                        CAPACITACIÓN) para uno de sus
                                                                        clientes con RUC:
                                                                        <strong>{{ $array['cliente'] }}</strong>. Te
                                                                        recomendamos ponerte en contacto con él lo antes
                                                                        posible para resolver cualquier duda o asistirlo
