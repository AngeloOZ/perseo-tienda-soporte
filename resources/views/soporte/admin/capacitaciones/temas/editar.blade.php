        ...
        <div class="d-flex flex-column-fluid">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <!--begin::Card-->
                        <form class="form" action="{{ route('temas.actualizar', $temas->temasid) }}" method="POST">
                            @method('PUT')
                                    ...
                                    <div class="card-toolbar">
                                        <div class="btn-toolbar justify-content-between" role="toolbar" aria-label="">
                                            <div class="btn-group" role="group" aria-label="First group">
                                                ...
                                                <a href="{{ route('temas.index') }}" class="btn btn-secondary btn-icon"
                                                ...
                                                <a href="{{ route('temas.crear') }}" class="btn btn-warning btn-icon"
