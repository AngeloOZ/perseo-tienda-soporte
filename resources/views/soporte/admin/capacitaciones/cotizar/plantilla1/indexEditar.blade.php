    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        <div class="d-flex flex-column-fluid">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <form class="form" action="{{ route('actualizarCotizacion.index', $cotizaciones->cotizacionesid) }}"
                            method="POST">
                            @method('PUT')
                                        ...
                                        <div class="btn-toolbar justify-content-between" role="toolbar" aria-label="">
                                            <div class="btn-group" role="group" aria-label="">
                                                ...
                                                <button type="submit" class="btn btn-icon"
                                                    ...
                                                    data-toggle="tooltip" title="Generar cotización" value="descargar_word"
                                                ...
                                                @if (Auth::user()->rol == 2)
                                                    <button type="button" class="btn btn-icon btn-info"
                                                        ...
                                                        title="Generar contrato" id="btnContrato"><i
                                                            class="la la-file-word"></i>
                                                    </button>
                                                @endif
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" class="form-control" placeholder="" name="subtotal"
                                                id="subtotal" value="{{ $cotizaciones->subtotal }}" readonly />
                                        </div>
                                        <div class="col-lg-6">
                                            <label>Iva:</label>
...
@endsection
@section('modal')
    @include('soporte.admin.capacitaciones.cotizar.plantilla1._modalContrato')
@endsection
@section('scriptFecha')
    <script>
