...
<div class="form-group row">
    ...
    <div class="col-lg-6">
        <label>Precio</label>
        <input type="text" class="form-control validarDigitos" placeholder="Ingrese el precio" name="precio"
            id="precio" autocomplete="off" value="{{ old('precio', $detalles->precio) }}" />
