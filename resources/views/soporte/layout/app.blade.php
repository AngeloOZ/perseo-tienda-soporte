...
<head>
    ...
    <link href="{{ asset('assets/css/calificar_soporte.css') }}" rel="stylesheet" type="text/css" />
...
<body id="kt_body"
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
        @include('soporte.layout.navBarMobile')
    </div>


    <div class="d-flex flex-column wrapper">
        @include('soporte.layout.navBar')
        @yield('contenido')
        @include('soporte.layout.footer')
    </div>
