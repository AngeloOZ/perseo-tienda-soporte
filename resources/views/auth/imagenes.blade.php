    ...
    <div class="col-md-12">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 mt-0 mt-md-0">
                <!--begin::Card-->
                <div class="card card-card-stretch mt-3 mt-md-0" style="height: 350px">
                    ...
                    <div class="card-body text-center m-2 p-2" style="margin: 0px;">
                        <div class="text-center">
                            <div class="image-input w-100 h-100" id="kt_image_3">
                                <a href="{{ route('firma.visualizar_imagen', ['firma' => $firma->firmasid, 'tipo' => 3]) }}"
            ...
            <div class="col-lg-4 mt-5 mt-md-0">
                <!--begin::Card-->
                <div class="card card-stretch mt-3 mt-md-0" style="height: 350px">
                    <div class="card-header mb-0 pb-0 pt-4">
                        <div class="card-title ">
                    ...
                    <div class="card-body text-center m-2 p-2" style="margin: 0px;">
                        <div class="text-center">
                            <div class="image-input  w-100 h-100" id="kt_image_1">
                                <a href="{{ route('firma.visualizar_imagen', ['firma' => $firma->firmasid, 'tipo' => 1]) }}"
                                    target="_blank" rel="noopener noreferrer">
                                    <div class="image-input-wrapper w-100 h-100 "
            ...
            <div class="col-lg-4 mt-5 mt-md-0">
                ...
                <div class="card card-card-stretch mt-3 mt-md-0" style="height: 350px">
                    ...
                    <div class="card-body text-center m-2 p-2" style="margin: 0px;">
                        <div class="text-center">
                            <div class="image-input w-100 h-100" id="kt_image_2">
                                <a href="{{ route('firma.visualizar_imagen', ['firma' => $firma->firmasid, 'tipo' => 2]) }}"
                                    target="_blank" rel="noopener noreferrer">
                                    <div class="image-input-wrapper w-100 h-100"
