    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        <div class="d-flex flex-column-fluid">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ route('cupones.actualizar', $cupon->cuponid) }}" method="POST">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="card-header d-block">
                                    <div class="d-flex justify-content-between flex-wrap">
                                        <div class="card-title">
                                            <h3 class="card-label"> Editar cupón #<strong>{{ $cupon->codigo }}</strong></h3>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        <div class="col-12 mb-2 col-md-6 mb-0">
                                            ...
                                            <select name="tipo"
                                                ...
                                                id="selectTipo">
                                                <option value="1" {{ $cupon->tipo == 1 ? 'selected' : '' }}>Descuento
                                                </option>
                                                <option value="2" {{ $cupon->tipo == 2 ? 'selected' : '' }}>Promoción +3 Meses</option>
                                            </select>
                                            @error('tipo')
                                        ...
                                        <div class="col-12 mb-2 col-md-6 mb-0">
                                            ...
                                            <input type="text" name="cupon"
                                                ...
                                                value="{{ $cupon->cupon }}" id="nombreCupon">
                                            @error('cupon')
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12 mb-2 col-md-6 mb-0">
                                            ...
                                            <input type="date"
                                                class="form-control {{ $errors->has('tiempo_vigencia') ? 'is-invalid' : '' }}"
                                                name="tiempo_vigencia" min="{{ date('Y-m-d') }}"
                                                value="{{ $cupon->tiempo_vigencia }}">
                                        ...
                                        <div class="col-12 mb-2 col-md-6 mb-0">
                                            ...
                                            <input type="number"
                                                class="form-control {{ $errors->has('limite') ? 'is-invalid' : '' }}"
                                                name="limite" id="limite" value="{{ $cupon->limite }}" min="1"
                                                max="10">
                                            @error('limite')
...
@section('script')
    <script>
        ...
        function validarDescuento() {
            if (descuento.value > 30 || descuento.value < 0) {
                descuento.value = 0;
