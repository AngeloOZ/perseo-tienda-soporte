    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        <div class="d-flex flex-column-fluid">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-none" id="alertaSuccess">
                            <div class="alert alert-custom alert-notice alert-success fade show" role="alert">
                                <div class="alert-icon"><i class="flaticon2-check-mark"></i></div>
                                <div class="alert-text">Correo enviado exitosamentente</div>
                        ...
                        <div class="d-none" id="alertaError">
                            <div class="alert alert-custom alert-notice alert-danger fade show" role="alert">
                                <div class="alert-icon"><i class="flaticon-warning"></i></div>
                                <div class="alert-text">Hubo un error al enviar el correo</div>
                                <div class="alert-close">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true"><i class="ki ki-close"></i></span>
                                    </button>
                                    ...
                                    <div class="card-toolbar">
                                        <div class="btn-toolbar justify-content-between" role="toolbar" aria-label="">
                                            <div class="btn-group" role="group" aria-label="First group">
                                                ...
                                                <a href="{{ route('firma.listado') }}" class="btn btn-secondary btn-icon"
                                                ...
                                                <button type="button" class="btn btn-primary btn-icon" id="btnSendEmail"
                                                    data-toggle="tooltip" title="Reenviar correo"
                                                    data-user-email="{{ Auth::user()->correo }}"
                                                    data-id-solicitud-firma="{{ $firma->firmasid }}">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content mt-5" id="myTabContent1">
                                        ...
                                        <div class="tab-pane fade" id="archivos-1" role="tabpanel"
                                            ...
                                            @include('auth.imagenes')
                                        </div>
                                        @if ($firma->estado >= 2)
                                            @include('auth.panel_solicitud')
                                        @endif
                                    </div>
                                </div>
                            </div>
...
@section('script')
    <script>
        ...
        function desactivarButtons(){
            const btn = document.getElementById('btnSendDocs');
