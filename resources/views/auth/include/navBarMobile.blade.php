...
<div class="d-flex align-items-center">
    @if (Auth::user()->rol == 1)
        <a href="{{ route('inicio', Auth::user()->usuariosid) }}" target="_blank" style="font-size: 20px"
            data-toggle="tooltip" data-theme="dark" title="Enlace de referido" class="mx-2">
            <i class="fas fa-globe mt-1">
            </i>
        </a>
        <a href="{{ route('tienda', Auth::user()->usuariosid) }}" target="_blank" style="font-size: 20px" data-toggle="tooltip" data-theme="dark" title="Enlace tienda" class="mx-3">
