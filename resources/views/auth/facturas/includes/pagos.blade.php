        ...
        <div class="row mt-0">
            <div class="col-12 mt-5 col-lg-6 mt-md-0">
                ...
                <div class="form-group mt-2">
                    ...
                    <textarea class="form-control" id="textObsPago2" name="observacion_pago_vendedor" style="resize: none" rows="3"  {{ $disabled }}>{{ $factura->observacion_pago_vendedor }}</textarea>
                </div>
