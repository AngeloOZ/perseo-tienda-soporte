...
@section('titulo', 'Liberar contafacil')
@section('contenido')
                ...
                function peticionLiberarProducto(url) {
                    axios.post(url, {
                        ...
                        .then(data => {
                            ...
                            const title = data?.status == 200 ? "Licencias liberadas" : "Licencias liberadas con errores";
                            const mensaje = data?.data?.message || "Las licencias se liberaron correctamente";
