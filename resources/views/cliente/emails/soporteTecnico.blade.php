                                            ...
                                            <td style="vertical-align:top;padding:0 0 0 0;">
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                    ...
                                                    <tbody>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td style="width:200px;"><img alt=""
                                                                                    height="auto"
                                                                                    src="{{ $message->embed(public_path() . '/assets/media/logos/logo.png') }}"
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                style="font-size:0px;padding:27px 25px 0px 25px;padding-top:27px;padding-right:25px;padding-bottom:0px;padding-left:25px;word-break:break-word;">
                                                                <div
                                                                    style="font-family:Arial, sans-serif;font-size:19px;letter-spacing:normal;line-height:1;text-align:left;color:#000000;">
                                                                    <p class="text-build-content"
                                                                        style="text-align: center; margin: 10px 0; margin-top: 10px; margin-bottom: 10px;"
                                                                        data-testid="YImpwe_iQflo"><span
                                                                            style="color:#1d6ea9;font-family:Arial;font-size:19px;"><b>!Saludos,
                                                                                es un placer informarle!</b></span></p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <td align="left"
                                                ...
                                                <div
                                                    ...
                                                    <p class="text-build-content" data-testid="JnKFIFS0T"
                                                        ...
                                                        <span style="font-family:Arial;">El soporte brindado del
                                                            producto<b>
                                                            </b>
                                                        </span><span style="font-family:Arial;font-size:16px;"><b>
                                                                "{{ $array['producto'] }}" </b></span>

                                                        <span style="font-family:Arial;font-size:14px;">con la siguiente
                                                            descripción:
                                                        </span>
                                                        ...
                                                        <span style="font-family:Arial;font-size:14px;">Ha tenido una
                                                            duración de:</span>
                                                        <span style="font-family:Arial;font-size:16px;"><b>
                                                                "{{ $array['duracion'] }}", </b></span>
                                                        <span style="font-family:Arial;font-size:14px;">contemplado
                                                            desde:</span>
                                                        <span style="font-family:Arial;font-size:15px;"><b>
                                                                "{{ $array['fechahorainicio'] }}" </b>,</span>
                                                        <span style="font-family:Arial;font-size:14px;">hasta:</span>
                                                        <span style="font-family:Arial;font-size:15px;"><b>
                                                                "{{ $array['fechahorafin'] }}". </b></span>

                                                    </p>

                                                    <span style="font-family:Arial;font-size:14px;">
                                                        Técnico encargado: </span><span
                                                        style="font-family:Arial;font-size:15px;"><b>
                                                            {{ $array['tecnico'] }}</b></span>
                                                    <br>
                                                    <br>
                                                    <span style="font-family:Arial;font-size:14px;;">
                                                        Tipo: </span><span style="font-family:Arial;font-size:15px;"><b>
                                                            {{ $array['tipo'] }}</b></span>
                                                    <br>
                                                    <br>

                                                    <span style="font-family:Arial;font-size:14px;;">
                                                        Soporte facturado: </span><span
                                                        style="font-family:Arial;font-size:15px;"><b>
                                                            {{ $array['facturado'] }}</b></span>
                                                    <br>
                                                    <br>
                                                    @if ($array['valorfacturado'] != null)
                                                        <span style="font-family:Arial;font-size:14px;;">
                                                            Valor facturado: </span><span
                                                            style="font-family:Arial;font-size:15px;"><b>

                                                                {{ $array['valorfacturado'] }}
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                style="background:#ffffff;font-size:0px;padding:0px 0px 0px 0px;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px;word-break:break-word;">
                                                                <p
                                                                    style="border-top:solid 4px #ffffff;font-size:1px;margin:0px auto;width:100%;">
                                                                </p>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            ...
                                                                                            <a href="https://www.facebook.com/sistemacontableperseoec"
                                                                                                target="_blank"><img
                                                                                                    height="27"
                                                                                                    src="{{ $message->embed(public_path() . '/assets/media/logos/facebook.png') }}"
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            ...
                                                                                            <a href="https://www.youtube.com/channel/UC5vW4mwvCNbWpCxRr_aqI7g"
                                                                                                target="_blank"><img
                                                                                                    height="27"
                                                                                                    src="{{ $message->embed(public_path() . '/assets/media/logos/youtube.png') }}"
                                                                                                    style="border-radius:50%;display:block;"
                                                                                                    width="27"></a>
                                                                                        </td>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            ...
                                                                                            <a href="https://www.instagram.com/sistemacontableperseoec/?hl=es"
                                                                                                target="_blank"><img
                                                                                                    height="27"
                                                                                                    src="{{ $message->embed(public_path() . '/assets/media/logos/instagram.png') }}"
                                                                                                    style="border-radius:50%;display:block;"
                                                                                                    width="27"></a>
                                                                                        </td>
                                                                                    </tr>
