                                            ...
                                            <td align="left"
                                                ...
                                                <div
                                                    ...
                                                    <p class="text-build-content" data-testid="JnKFIFS0T"
                                                        ...
                                                        <span style="font-family:Arial;">La capacitación del Producto<b>
                                                            </b>
                                                        </span><span style="font-family:Arial;font-size:16px;"><b>
                                                                "{{ $array['producto'] }}" </b></span>

                                                        <span style="font-family:Arial;font-size:14px;">en la categoría
                                                        </span>
                                                        </span><span style="font-family:Arial;font-size:16px;"><b>
                                                                "{{ $array['categoria'] }}", </b>
                                                        </span>
                                                        <span style="font-family:Arial;font-size:14px;">con los
                                                            siguientes temas:
                                                        </span>
                                                        <span style="font-family:Arial;font-size:16px;">

                                                            <ul class="list-group">
                                                                @for ($i = 0; $i < count($array['tema']); $i++)
                                                        ...
                                                        <span style="font-family:Arial;font-size:14px;">ha concluido
                                                            satisfactoriamente para las siguientes personas:</span>
                                                    </p>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td style="vertical-align:top;padding:0 0 0 0;">
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                style="background:#eff5fa;font-size:0px;padding:17px 25px 17px 25px;padding-top:17px;padding-right:25px;padding-bottom:17px;padding-left:25px;word-break:break-word;">
                                                                <div
                                                                    ...
                                                                    <p class="text-build-content"
                                                                        ...
                                                                        data-testid="oiR1cPkdb"><span
                                                                            style="color:#1d6ea9;font-family:Arial;font-size:16px;letter-spacing:2px;">{{ $array['colaboradores'] }}</span>
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p class="text-build-content" data-testid="JnKFIFS0T"
                                                                        ...
                                                                        <span style="font-family:Arial;font-size:14px;">
                                                                            ...
                                                                            style="font-family:Arial;font-size:16px;"><b>
